...
<html lang="en">
    ...
    <body>
        <div class="main text-white pt-10" style="background: repeating-linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.8)), url('{{ $image }}') center center / cover no-repeat;">
